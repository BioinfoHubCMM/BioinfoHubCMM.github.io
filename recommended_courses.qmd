...
IDEs are software applications that provide an environment for writing, debugging, running and testing code. There are several options, but two popular options are [RStudio](https://posit.co/products/open-source/rstudio/?sid=1) and [Visual Studio code (VSCode)](https://code.visualstudio.com/). 

### R & RStudio installation
- **[R & RStudio installation](https://posit.co/download/rstudio-desktop/)**
